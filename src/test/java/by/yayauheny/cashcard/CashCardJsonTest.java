...
public class CashCardJsonTest {
    ...
    public void cashCardSerializationTest() throws IOException {
        ...
        assertThat(json.write(cashCard)).isStrictlyEqualToJson(this.getClass().getClassLoader().getResourceAsStream("json/single.json"));
    ...
    void cashCardListSerializationTest() throws IOException {
        assertThat(jsonList.write(cashCards))
                .isStrictlyEqualToJson(this.getClass().getClassLoader().getResourceAsStream("json/list.json"));
    }
